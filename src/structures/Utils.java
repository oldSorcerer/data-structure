...
class Utils {
    ...
    //TODO: Зачем тебе вообще поиск екстремума, если в списках он не нужен, это математическая операция жестко завязанная
    //      сравнивать объекты у тебя лист может содержать элементы не Компарабельные, что тогда твой екстремум будет возвращать?
